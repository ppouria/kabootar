...
val appVersionName = (versionProps.getProperty("version_name") ?: "0.6.1").trim().ifBlank { "0.6.1" }
val appVersionCode = ((versionProps.getProperty("version_code") ?: "8").trim().toIntOrNull() ?: 8).coerceAtLeast(1)
