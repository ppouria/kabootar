...
val appVersionName = (versionProps.getProperty("version_name") ?: "0.5.1").trim().ifBlank { "0.5.1" }
val appVersionCode = ((versionProps.getProperty("version_code") ?: "6").trim().toIntOrNull() ?: 6).coerceAtLeast(1)
